    ...
    void FixedUpdate()
    {
        if (Cursor.lockState == CursorLockMode.Locked)
        {
            ...
            if (isGrounded)
            {
                ...
                Vector3 jumpDirection = CharacterModel.transform.forward * maxSpeed + Vector3.up * jumpForce;
...
//            // Apply movement through rb.velocity
//            Vector3 newVelocity = new Vector3(movement.x, rb.velocity.y - 0.05f, movement.z); // Preserve Y-axis (vertical) velocity
